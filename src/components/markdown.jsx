...
// const preprocessTaskLists = (content) => {
//   if (!content) return '';
...
// const preprocessFootnotes = (content) => {
//   if (!content) return '';
...
// const CollapsibleDetails = ({ children, summary }) => {
...
// export default function Markdown({ content = '', darkMode = false }) {
